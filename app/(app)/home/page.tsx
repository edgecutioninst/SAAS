...
function Home() {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            {videos.length === 0 ? (
                <div className="flex flex-col items-center justify-center mt-16 p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                    ...
                    <Link
                        href="/video-upload"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold transition-all flex items-center gap-2"
                    >
